...
/**
 * queue_node - appends a node to a stack_t stack in queue_node
 * @stack: stack head
...
/**
 * add_node - appends a node to the beginning of a stack_t stack
 * @stack: stack head
...
/**
 * print_stack - displays the contents of a stack_t stack
 * @stack: stack head
 *
